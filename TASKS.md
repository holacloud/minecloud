...
- [ ] FEAT: Añadir emotes sonoros de proximidad. Comandos `/laugh`, `/cheer` y `/boo` que reproducen sonidos procedurales cortos audibles por jugadores cercanos con volumen segun distancia. El cliente envia posicion y tipo; el servidor retransmite; cada cliente reproduce si esta cerca.
