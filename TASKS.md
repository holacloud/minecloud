...
- [ ] FEAT: Añadir ping de ubicacion multijugador. Comando `/ping` que crea durante unos segundos un marcador visible en la posicion del jugador, por ejemplo un haz de luz o sprite vertical. El servidor debe retransmitir posicion y nombre; los clientes cercanos lo ven y desaparece solo.
