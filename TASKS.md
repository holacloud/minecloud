...
- [ ] FEAT: Añadir mensajes flotantes temporales multijugador. Comando `/sayhere texto` que crea un texto flotante en la posicion del jugador durante unos 30 segundos. El servidor debe retransmitirlo por websocket y cada cliente debe renderizarlo como sprite estilo nametag. No necesita persistencia ni modificar bloques.
