...
- [ ] FEAT: Añadir reacciones visuales sobre jugadores. Al apuntar a otro jugador y usar un comando sencillo como `/react heart`, `/react clap` o `/react confetti`, se debe mostrar un efecto breve alrededor de ese avatar para todos los jugadores cercanos. Reutilizar raycast de jugadores y eventos websocket.
