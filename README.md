...
- Ambient interactive mobs: sheep, ducks, pigs, adorable giraffes, and colorful macaws.
...
- Chat slash commands such as `/help`, `/spawn`, `/mob giraffe`, `/mob macaw`, `/rtx`, and `/time`.
